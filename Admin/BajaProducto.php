...
?>
	...
	<script>
        ...
        function mostrarForm(id) {
                ...
                if (confirm("¿DESEAS ELIMINAR ESTE REGISTRO "+id+"?") == true) {
                    $.post("EliminarProducto.php", {IDProducto: idproducto}, function(mensaje){
    ...
    <main  class="mdl-layout__content mdl-color--grey-100">
        <div class="ui three item menu">
            ...
            <a href="BajaProducto.php" class="item active"><i class="trash icon"></i> ELIMINAR</a>
        </div>

        <div class="ui raised very padded text container segment">
            <h4 class="ui dividing header"> Buscar Producto a Eliminar</h4>    
            <br>  
